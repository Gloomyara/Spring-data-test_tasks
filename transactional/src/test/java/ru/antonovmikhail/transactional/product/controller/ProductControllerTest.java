...
class ProductControllerTest {
    ...
    @Autowired
    private MockMvc mvc;
    private final NewProductDto dtoIn = new NewProductDto("Лампочка", "китайская", BigDecimal.valueOf(100), 1000L);

    private final ProductDtoOut dtoOut = new ProductDtoOut("Лампочка", "китайская", BigDecimal.valueOf(100), 1000L);
